...
<!-- Mirrored from preview.colorlib.com/theme/libchurch/sermons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 May 2025 19:52:16 GMT -->
<head>
	<title>BEYOND FAITH INTERNATIONAL</title>
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="faith/css/font-awesome.min.css"/>
	<link rel="stylesheet" href="faith/css/themify-icons.css"/>
...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-3 col-md-3 col-lg-3">
					<div class="social">
						<a href="https://web.facebook.com/livinus.c.nneji"><i class="ti-facebook"></i></a>
	...
	<header class="header-section">
		<div class="container">		
			<!-- logo -->
			<a href="index-2.html" class="site-logo"><img src="img/logo.png" alt=""></a>
			...
			<nav class="main-menu">
					...
					<li  class="active"><a href="{{url('messege')}}">Sermons</a></li>
					<li><a href="{{url('ebooks_user')}}">Ebooks</a></li>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="faith/img/bg.jpg">
	...
	<section class="sermon-section spad">
		...
		<div class="sermon-warp">
			<div class="sermon-left-bg set-bg" data-setbg="faith/img/sermon-bg.jpg"></div>
			<div class="container">
				<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4">
					<div class="sermon-item">
						<div class="si-thumb set-bg" data-setbg="images/{{$data->images}}"></div>
						<div class="si-content">
							<h4>{{$data->header}}</h4>
							<ul class="sermon-info">
								<li>Sermon From: <span>Livinu C. Nneji</span></li>
								<!-- <li>Categories: <span>God, Pray</span></li> -->
								<li><span>On {{$data->created_at}}</span></li>
							</ul>
							<div class="icon-links">
								<a href="#"><i class="ti-link"></i></a>
								<a href="#"><i class="ti-zip"></i></a>
				...
				<div class="col-sm-6 col-md-4">
					<div class="sermon-item">
						<div class="si-thumb set-bg" data-setbg="img/sermons/5.jpg"></div>
						<div class="si-content">
				...
				<div class="col-sm-6 col-md-4">
					<div class="sermon-item">
						<div class="si-thumb set-bg" data-setbg="img/sermons/6.jpg"></div>
						<div class="si-content">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 footer-top-content">
					...
					<p><span>Email:</span> <a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6a03040c052a090506051806030844090507">[email&#160;protected]</a></p>
					<h4>Phone:</h4>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!--====== Javascripts & Jquery ======-->
	<script src="faith/js/jquery-3.2.1.min.js"></script>
	<script src="faith/js/jquery.countdown.js"></script>
	<script src="faith/js/main.js"></script>

	<!-- load for map -->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB0YyDTa0qqOjIerob2VTIwo_XVMhrruxo"></script>
	<script src="faith/js/map.js"></script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"942e5ab9bef671e0","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"cd0b4b3a733644fc843ef0b185f98241","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/libchurch/sermons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 May 2025 19:53:27 GMT -->
</html>