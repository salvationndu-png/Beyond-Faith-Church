          ...
          <div class="content-wrapper p-4">
            ...
            <div class="row">
                <div class="col-12">
                  ...
                  <form action="{{url('message_id_upload',$data->id)}}" enctype="multipart/form-data" method="post">
                  <a class="btn btn-primary" href="{{url('messages')}}"><i class='bx bx-left-arrow-alt'></i></a>
                    @csrf
                  <div class="card">
