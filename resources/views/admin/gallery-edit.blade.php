          ...
          <div class="content-wrapper p-4">
            ...
            <div class="row">
                <div class="col-12">
                  ...
                  <form action="{{url('gallery_id_upload',$data->id)}}" enctype="multipart/form-data" method="post">
                  <a class="btn btn-primary" href="{{url('admingallery')}}"><i class='bx bx-left-arrow-alt'></i></a>
                    @csrf
                  <div class="card">
