          ...
          <div class="content-wrapper p-4">
            ...
            <div class="row">
                <div class="col-12">
                  ...
                  <form action="{{url('ebooks_id_upload',$data->id)}}" enctype="multipart/form-data" method="post">
                  <a class="btn btn-primary" href="{{url('ebooksource')}}"><i class='bx bx-left-arrow-alt'></i></a>
                    @csrf
                  <div class="card">
                    <h5 class="card-header">EDIT EBOOKS </h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      ...
                      <div class="input-group">
                        ...
                        @if($data->images)
                            <img src="{{ asset($data->images) }}" class="img-fluid rounded-top" alt="Current Image">
                        @endif
